...
public class SpellConfig extends ConfigGod
{
	...
	//Sets
	public void setEffectID(int i, int x) { ccm.set(prefix + i + ".effectID", x); }
	...
	public void setIntelligenceMagnitude(int i, double a, double b, double c, double d, double e) { ccm.set(prefix + i + ".intelligenceMagnitude", a + "," + b + "," + c + "," + d + "," + e); }
	public void setConstitutionMagnitude(int i, double a, double b, double c, double d, double e) { ccm.set(prefix + i + ".constitutionMagnitude", a + "," + b + "," + c + "," + d + "," + e); }
	public void setRadius(int i, int a, int b, int c, int d, int e) { ccm.set(prefix + i + ".radius", a + "," + b + "," + c + "," + d + "," + e); }
	
	public void setTargetParty(int i, boolean x) { ccm.set(prefix + i + ".targetParty", x); }
	public void setRestricted(int i, boolean x) { ccm.set(prefix + i + ".restricted", x); }
	
	//Gets
	public int getEffectID(int i) { return ccm.getInt(prefix + i + ".effectID"); }
	...
	public List<Double> getIntelligenceMagnitude(int i) { try { return converter.getDoubleListFromString(ccm.getString(prefix + i + ".intelligenceMagnitude")); } catch (NullPointerException e) { return null; } }
	public List<Double> getConstitutionMagnitude(int i) { try { return converter.getDoubleListFromString(ccm.getString(prefix + i + ".constitutionMagnitude")); } catch (NullPointerException e) { return null; } }
	public List<Integer> getRadius(int i) { try { return converter.getIntegerListFromString(ccm.getString(prefix + i + ".radius")); } catch (NullPointerException e) { return null; } }
	
	public boolean getTargetParty(int i) { return ccm.getBoolean(prefix + i + ".targetParty"); }
	public boolean getRestricted(int i) { return ccm.getBoolean(prefix + i + ".restricted"); }
