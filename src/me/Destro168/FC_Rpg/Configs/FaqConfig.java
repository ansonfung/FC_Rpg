...
{
	public void setHeader(int i, String x) { fcw.set(prefix + i + ".header", x); }
	public void setDisplayTag(int i, String x) { fcw.set(prefix + i + ".displayTag", x); }
	public void setFaqList(int i, int a, List<String> x) { fcw.setList(prefix + i + ".faqList" + a, x); } //a = 1 or 2
	
	public String getHeader(int i) { return fcw.getString(prefix + i + ".header"); }
	public String getDisplayTag(int i) { return fcw.getString(prefix + i + ".displayTag"); }
	public List<String> getFaqList(int i, int a) { return fcw.getStringList(prefix + i + ".faqList" + a); }
	
	public void setFaqNull(String faqKeyWord) { fcw.set(prefix + getFaqIndex(faqKeyWord), null); }
